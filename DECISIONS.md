...
## 2026-06-24 — Accès webui = Tailscale (privé), PAS d'expo publique `jarvis.bienpreter.com`

**Contexte** : exposer la webui pour un accès pratique (Michael depuis ses appareils). Option publique `jarvis.bienpreter.com` (Caddy + Let's Encrypt) envisagée.
