...
- **2026-06-23** — **Durcissement OS étape A** (Phase 0) : `apt upgrade` (78 MAJ), **swapfile 4 Gi** + `vm.swappiness=10` (prudence ollama/Honcho sur RAM sans swap), install `ufw` + `fail2ban`. sshd déjà key-only (`passwordauthentication no`). unattended-upgrades actif.
